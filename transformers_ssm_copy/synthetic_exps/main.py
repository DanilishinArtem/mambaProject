...
def print_results(str_acc_mean_list, str_acc_std_list, char_accuracy_list):
    print("STR ACCURACY MEAN")
    print(str_acc_mean_list)
    print("STR ACCURACY STD")
    print(str_acc_std_list)
    print("CHAR ACCURACY")
    print(char_accuracy_list)

print_results(str_acc_mean_list, str_acc_std_list, char_accuracy_list)
