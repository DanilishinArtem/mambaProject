...
python3 synthetic_exps/main.py --model "mambapp" --train_task "copy" --eval_task  "copy" --min_train_len 50 --max_train_len 100 --min_eval_len 95 --max_eval_len 100 --steps 300 --heads 1 --n_gram 0 --context_len 220 #--layers 1
