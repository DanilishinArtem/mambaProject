...
from models.mambaGpu import MambaPlusPlusML
...
def run_experiment(epochs):
    ...
    models = {
        "Mamba++": MambaPlusPlusML(vocab_size=vocab_size, embed_dim=embed_dim, hidden_dim=embed_dim, num_heads=heads, num_layers=8)
    }
